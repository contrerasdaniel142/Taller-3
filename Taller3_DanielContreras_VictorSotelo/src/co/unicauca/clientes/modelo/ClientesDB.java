...
public class ClientesDB extends java.util.Observable {
    ...
    {
        double totalPersonas=totalHombres+totalMujeres;
        porcentajeHombres=((double)totalHombres/(double)totalPersonas)*100;
        porcentajeMujeres=((double)totalMujeres/(double)totalPersonas)*100;
    }
